    ...
    <>
      ...
      <section className="w-full flex flex-col items-center justify-start py-12">
        ...
        <div className="flex items-center gap-2 h-[400px] w-full max-w-5xl mt-10 px-4">
          {[
            "/assets/images/drive_photos/folder_1/PKP_-21.jpg",
            "/assets/images/drive_photos/folder_2/FS-106.jpg",
            "/assets/images/drive_photos/folder_3/PKP-12.jpg",
            "/assets/images/drive_photos/folder_4/FS-100.jpg",
            "/assets/images/drive_photos/folder_1/PKP_-35.jpg",
            "/assets/images/drive_photos/folder_4/FS-111.jpg",
          ].map((src, idx) => (
            <div
              key={idx}
